...
// Get all users except the current session's username
$result = $mysqli->query("SELECT * FROM tbluseraccount WHERE userType = 0 AND username != '$currentUsername'") or die($mysqli->error);
