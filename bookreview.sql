...
(12, 1, 'admin', '2023-05-13', '23:28:18', 'Magnificent!!', 'A total masterpiece, I would get pregnant if I was a female while reading this.', 5, 1),
(13, 1, 'admin', '2023-05-13', '23:28:56', 'Interesting Enough', 'It has some really deep thoughts into it, I don\'t know how to feel about it. One thing\'s for sure, It\'s interesting.', 4, 1),
(14, 2, 'TestMod', '2023-05-13', '23:30:36', 'Confusing', 'It\'s too much info dump. The book is dumping too much data unto the readers it\'s confusing!', 2, 1),
...
(19, 5, 'testMod', '2023-05-15', '08:59:25', 'Tis book is nicee!', 'Tis book is nicee!', 5, 1),
(20, 3, 'testMod', '2023-05-15', '08:59:56', 'This book is nice!', 'This book is nice!', 5, 1);
...
('Christian', 'Gantuangco', 'user', 'user', 0, 'user@email.com', 0);
